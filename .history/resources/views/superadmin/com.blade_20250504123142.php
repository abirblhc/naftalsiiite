                                                        ...
                                                        <div class="flex flex-wrap gap-2">
                                                            @if($child->children)
                                                                @foreach($child->children as $subChild)
                                                                    @if($subChild->name !== 'GD')
                                                                        <a href="{{ route('superadmin.sites.branche.detail', ['site' => $commercialBranche->site_id, 'brancheType' => 'Agence', 'branch' => $subChild->id]) }}" class="flex-1 min-w-[120px]">
                                                ...
                                                <div class="bg-white rounded-xl shadow-lg overflow-hidden h-full">
                                                    ...
                                                    <div class="p-4">
                                                        <div class="flex flex-wrap gap-2">
                                                            @if($child->children)
                                                                @foreach($child->children as $subChild)
                                                                    <a href="{{ route('superadmin.sites.branche.detail', ['site' => $commercialBranche->site_id, 'brancheType' => 'LP', 'branch' => $subChild->id]) }}" class="flex-1 min-w-[120px]">
                                                ...
                                                <div class="bg-white rounded-xl shadow-lg overflow-hidden h-full">
                                                    ...
                                                    <div class="p-4">
                                                        <div class="flex flex-wrap gap-2">
                                                            @if($child->children)
                                                                @foreach($child->children as $subChild)
                                                                    <a href="{{ route('superadmin.sites.branche.detail', ['site' => $commercialBranche->site_id, 'brancheType' => 'CDD', 'branch' => $subChild->id]) }}" class="flex-1 min-w-[120px]">
                                                ...
                                                <div x-show="isOpen" x-transition class="p-4 bg-purple-50">
                                                    <div class="flex flex-col gap-2">
                                                        @foreach($subChild->children as $station)
                                                            <a href="{{ route('superadmin.sites.branche.detail', ['site' => $commercialBranche->site_id, 'brancheType' => 'GD', 'branch' => $station->id]) }}" class="block">
