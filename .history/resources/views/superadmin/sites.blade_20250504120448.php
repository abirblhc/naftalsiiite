        ...
        <div class="bg-white/70 backdrop-blur-lg shadow-2xl rounded-2xl p-8 max-w-7xl mx-auto mt-8">
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <a href="{{ route('superadmin.sites.branche', ['site' => $site->id, 'branchType' => 'carburant']) }}"
                    ...
                    <a href="{{ route('superadmin.sites.branche', ['site' => $site->id, 'branchType' => 'commercial']) }}"
