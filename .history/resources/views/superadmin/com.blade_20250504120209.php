                                ...
                                @if($commercialBranche->children)
                                    @foreach($commercialBranche->children as $child)
                                        @if($child->name === 'Agence')
                                            <!-- Agence Card -->
                                            <a href="{{ route('superadmin.sites.branche', ['site' => $site->id, 'branchType' => 'Agence']) }}">
                                        ...
                                        @elseif($child->name === 'LP')
                                            <!-- LP Card -->
                                            <a href="{{ route('superadmin.sites.branche', ['site' => $site->id, 'branchType' => 'LP']) }}">
                                                <div class="bg-white rounded-xl shadow-lg overflow-hidden h-full">
                                        ...
                                        @elseif($child->name === 'CDD')
                                            <!-- CDD Card -->
                                            <a href="{{ route('superadmin.sites.branche', ['site' => $site->id, 'branchType' => 'CDD']) }}">
                                                <div class="bg-white rounded-xl shadow-lg overflow-hidden h-full">
