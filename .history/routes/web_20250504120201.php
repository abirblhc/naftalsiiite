...
Route::prefix('superadmin')->name('superadmin.')->group(function () {
    ...
    Route::get('/com', [BrancheController::class, 'commercialStructure'])->name('com');
    Route::get('/cbr', [BrancheController::class, 'carburantSites'])->name('cbr');

    // Branch routes
    Route::get('/sites/{site}/branche/{branchType}', [BrancheController::class, 'showBranch'])->name('sites.branche');
    Route::get('/sites/{site}/branche/{branchType}/{branch}', [BrancheController::class, 'showBranchDetail'])->name('sites.branche.detail');
});
...
Route::get('/superadmin/com', [BrancheController::class, 'commercialStructure'])->name('superadmin.com');
...
Route::prefix('sites')->group(function () {
    ...
    Route::get('/{site}/{branchType}', [SiteController::class, 'showBranche'])->name('sites.branche');
    Route::get('/{site}/{branchType}/{branch}', [SiteController::class, 'showBrancheDetail'])->name('sites.branche.detail');
});
