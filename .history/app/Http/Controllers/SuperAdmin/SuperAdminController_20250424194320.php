...
class SuperAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            'name' => $request->name,
            'email' => strtolower($request->email), // Force email to lowercase
            'role' => $request->role,
        ...
        // Redirect back with success message and password information
        return redirect()->route('superadmin.utilisateurs')
                         ->with('success', 'Utilisateur créé avec succès. Le mot de passe par défaut est : defaultpassword');
    }
